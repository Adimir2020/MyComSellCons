...
while True:
    if choice == 1:
        ...
        if nV == 1 and nR ==1 or nR == 0 and nM == 1 or nM == 0 and nVc == 1 or nVc == 0:
            ...
            print()
            print('Здравствуйте, меня зовут '+NameUser+'. Обращаюсь к вам с жалобой на пользователя '+RogueName+' ('+LinkRouge+'). '+' Прошу помочь вернуть нанесенный им ущерб в размере '+SumUser+'. ''Имеются все доказательства мошенничества. Жду ответа!')
            print()
